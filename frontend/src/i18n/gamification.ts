  ...
  es: {
    gamification: {
      ...
      badges: {
        ...
        available: 'Insignias Disponibles',
        noBadges: 'Aún no has obtenido insignias',
      },
      challenges: {
        title: 'Desafíos',
        active: 'Desafíos Activos',
        completed: 'Desafíos Completados',
        join: 'Unirse al Desafío',
        leave: 'Abandonar Desafío',
        progress: 'Progreso',
  ...
  fr: {
    gamification: {
      ...
      level: {
        ...
        progress: 'Progression au Niveau Suivant',
      },
      badges: {
        title: 'Badges',
