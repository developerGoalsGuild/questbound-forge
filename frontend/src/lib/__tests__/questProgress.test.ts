...
describe('Quest Progress Calculation', () => {
  describe('calculateLinkedQuestProgress', () => {
    it('should calculate progress for a completed linked quest', () => {
      const quest: Quest = {
        id: '1',
        userId: 'user1',
        title: 'Test Quest',
      ...
      const progress = calculateLinkedQuestProgress(quest);
    ...
    it('should calculate progress for an active linked quest with simulated progress', () => {
      const quest: Quest = {
        id: '2',
        userId: 'user1',
        title: 'Active Quest',
    ...
    it('should handle linked quest with no linked items', () => {
      const quest: Quest = {
        id: '3',
        userId: 'user1',
        title: 'Empty Quest',
    ...
    it('should throw error for non-linked quest', () => {
      const quest: Quest = {
        id: '4',
        userId: 'user1',
      ...
      expect(() => calculateLinkedQuestProgress(quest)).toThrow('Quest must be of type "linked"');
    });
  });

  describe('calculateQuantitativeQuestProgress', () => {
    it('should calculate progress for a completed quantitative quest', () => {
      const quest: Quest = {
        id: '5',
        userId: 'user1',
      ...
      const progress = calculateQuantitativeQuestProgress(quest);
    ...
    it('should calculate progress for an active quantitative quest with simulated progress', () => {
      const quest: Quest = {
        id: '6',
        userId: 'user1',
    ...
    it('should handle quantitative quest with no progress', () => {
      const quest: Quest = {
        id: '7',
        userId: 'user1',
    ...
    it('should throw error for non-quantitative quest', () => {
      const quest: Quest = {
        id: '8',
        userId: 'user1',
        title: 'Linked Quest',
      ...
      expect(() => calculateQuantitativeQuestProgress(quest)).toThrow('Quest must be of type "quantitative"');
    });

    it('should throw error for invalid target count', () => {
      const quest: Quest = {
        id: '9',
        userId: 'user1',
        title: 'Invalid Quest',
      ...
      expect(() => calculateQuantitativeQuestProgress(quest)).toThrow('Quantitative quest must have a valid target count');
    });

    it('should throw error for missing count scope', () => {
      const quest: Quest = {
        id: '10',
        userId: 'user1',
        title: 'Invalid Quest',
      ...
      expect(() => calculateQuantitativeQuestProgress(quest)).toThrow('Quantitative quest must have a count scope');
    });
    ...
    it('should throw error for invalid period', () => {
      ...
      expect(() => calculateQuantitativeQuestProgress(quest)).toThrow('Quantitative quest must have a valid period');
    });
  });

  describe('calculateQuestProgress', () => {
    it('should calculate progress for linked quest', () => {
      const quest: Quest = {
        id: '12',
        userId: 'user1',
        title: 'Linked Quest',
    ...
    it('should calculate progress for quantitative quest', () => {
      const quest: Quest = {
        id: '13',
        userId: 'user1',
        title: 'Quantitative Quest',
    ...
    it('should handle unsupported quest kind gracefully', () => {
      const quest = {
        id: '14',
        userId: 'user1',
        title: 'Unknown Quest',
  ...
  describe('calculateDetailedQuestProgress', () => {
    it('should return detailed progress for linked quest', () => {
      const quest: Quest = {
        id: '16',
        userId: 'user1',
        title: 'Linked Quest',
      ...
      const progress = calculateDetailedQuestProgress(quest);
    ...
    it('should return detailed progress for quantitative quest', () => {
      const quest: Quest = {
        id: '17',
        userId: 'user1',
        title: 'Quantitative Quest',
