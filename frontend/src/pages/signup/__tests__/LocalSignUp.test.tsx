...
describe('LocalSignUp', () => {
  ...
  test('country placeholder is localized to Spanish', async () => {
    renderWithLanguage('es');
    const countryInput = await screen.findByPlaceholderText(containsNormalized('Selecciona tu país'));
    expect(countryInput).toBeInTheDocument();
  });

  test('country placeholder is localized to French', async () => {
    renderWithLanguage('fr');
    const countryInput = await screen.findByPlaceholderText(containsNormalized('Sélectionnez votre pays'));
    expect(countryInput).toBeInTheDocument();
  });
  ...
  test('Spanish labels are present when language is es', () => {
    renderWithLanguage('es');
    expect(screen.getByLabelText(containsNormalized('Correo electrónico'))).toBeInTheDocument();
