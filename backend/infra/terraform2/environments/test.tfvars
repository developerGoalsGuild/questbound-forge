...
cache_enabled = false  # Disable caching for test environment
api_stage_name = "v1"

# API Gateway overrides (to avoid remote_state dependency in test)
lambda_authorizer_arn_override   = "arn:aws:lambda:us-east-1:838284111015:function:goalsguild_authorizer_test"
user_service_lambda_arn_override = "arn:aws:lambda:us-east-1:838284111015:function:goalsguild_user_service_test"
quest_service_lambda_arn_override = "arn:aws:lambda:us-east-1:838284111015:function:goalsguild_quest_service_test"

# Security stack: reuse existing Lambda exec role in test
existing_lambda_exec_role_name = "goalsguild_lambda_exec_role_test"

# JWT secret for user authentication
jwt_secret = "test-secret-key-for-testing-only"

# Email token secret for email verification
email_token_secret = "email-verification-secret-key-test"

# Google OAuth credentials (placeholders for test)
...
# Database stack values (to avoid remote_state dependency in test)
...
collaboration_service_lambda_arn_override = "arn:aws:lambda:us-east-1:838284111015:function:goalsguild_collaboration_service_test"
