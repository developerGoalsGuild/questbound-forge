...
AUTO_APPROVE="true"
SKIP_INIT=""
TF_LOG_PATH="$HOME/terraform-logs/tf-security.log"
...
STACK_PATH="$TERRAFORM_DIR/stacks/security"
...
print_info "Starting security stack deployment for environment: $ENV"
...
(
    ...
    if [ $? -eq 0 ]; then
        print_success "Security stack deployment completed"
    else
