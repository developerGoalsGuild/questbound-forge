...
AUTO_APPROVE="true"
SKIP_INIT=""
TF_LOG_PATH="$HOME/terraform-logs/tf-ecr.log"
...
STACK_PATH="$TERRAFORM_DIR/stacks/ecr"
...
print_info "Starting ECR stack deployment for environment: $ENV"
