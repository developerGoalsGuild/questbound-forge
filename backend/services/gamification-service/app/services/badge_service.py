...
from ..db.badge_db import (
    assign_badge, get_user_badges, has_badge,
    get_badge_definition, list_badge_definitions, BadgeDBError
)
from ..models.badge import BadgeDefinition, UserBadge, BadgeWithDefinition
...
def get_user_badges_with_definitions(user_id: str) -> List[BadgeWithDefinition]:
    """
