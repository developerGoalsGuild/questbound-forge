# Utils package for quest-service
"""
Re-export all utility functions for backwards compatibility.
The functions were originally in utils.py but moved here to support
the utils/ package structure with reward_calculator.py.
"""
...
def _validate_answers(raw_answers) -> List[Dict[str, str]]:
    """Validate answers from AnswerInput list."""
