"""
Quest Reward Calculator (Guild Service)
...
def calculate_guild_quest_reward(
    kind: str,
    ...
    """
    Calculate reward XP for a guild quest based on scope, period, and difficulty.
    ...
    difficulty_weight = GUILD_QUEST_WEIGHT
...
def _calculate_scope(
    ...
    if kind == "quantitative":
        ...
        if count_scope == "goals":
            ...
            # guild_quest scope: use base count (will get 3x from difficulty_weight)
