"""
Test API endpoints with proper mocking to improve coverage.
Tests the actual FastAPI endpoints using TestClient with mocked dependencies.
"""
...
# Mock AWS services before importing anything
...
class TestAPISimpleEndpoints:
    """Test FastAPI endpoints with proper mocking to improve coverage."""
