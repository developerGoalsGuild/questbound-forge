...
### Description
Objective: Execute **17.4 – Add user milestones (backend)** with precise steps that an AI agent can follow to completion.
...
- [ ] Define user milestone data models
- [ ] Implement user milestone CRUD operations
- [ ] Add user milestone validation logic
- [ ] Create user milestone API endpoints
- [ ] Update progress calculation to include user milestones
- [ ] Add GraphQL mutations for user milestones
